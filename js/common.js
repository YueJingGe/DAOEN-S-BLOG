  ...
  s.prototype = {
    ...
    _transfromClass: function (t, i) {
      ...
      this.ele.addEventListener("transitionend", function t(s) {
        e.ele === s.target && (i(), e.ele.removeEventListener("transitionend", t))
      }), this._toggleClass(t)
    },
    _animationClass: function (t, i) {
      var e = this;
      this.ele.addEventListener("animationend", function t(s) {
        e.ele === s.target && (i(), e.ele.removeEventListener("animationend", t))
      }), this._toggleClass(t)
    },
    _toggle: function () {
      var t = this.record[this.index];
      if (this.index === this.record.length || -1 === this.index) return this.end && this.end(), this.index = 0 < this.dir ? this.index - 1 : 0, this.dir *= -1, void(this.status = !1);
      switch (t.type) {
        case "class":
    ...
    lastStart: function () {
      var s = this;
      return this.status = !1, this.index = this.record.length - 1, this.dir = -1, this.record.forEach(function (t) {
...
! function (t) {
  ...
  i.prototype = {
    _init: function () {
      return this.index = 0, this.nowIndex = 0, this.timer = null, this.time = 0, this.startTime = null, this.record.forEach(function (e) {
      ...
      switch (s) {
        case "linear":
          return e = (i = {
            ...
            aims: u,
            spendTime: h
          }).time, n = i.now, r = i.aims, o = n + 60 * (r - n) / (e - i.spendTime), 0 < r - n ? r <= o ? r : o : o <= r ? r : o
      }
    },
    _emit: function (t, i) {
    ...
    start: function () {
      ...
      return this.next()._emit("start")._request(function t() {
        var n = e[o.nowIndex],
          r = {};
        if (!o.startTime && o.timeoutMap[-1]) return o.startTime = (new Date).getTime(), o.pause(), void setTimeout(function () {
          o._request(t)
        }, o.timeoutMap[-1]);
        if (o.time === n._time) {
          var i = o.timeoutMap[o.nowIndex];
          if (o.time = 0, o.nowIndex++, i) return o.pause(), void setTimeout(function () {
            o._request(t)
          }, i);
          n = e[o.nowIndex]
        }
        o.nowIndex !== e.length ? (eachObj(n, function (t, i) {
          if (!~i.indexOf("_")) {
            ...
            r[i] = e, (n[i].now = e) === t.to && (o.time = n._time)
          }
        }), o.time != n._time && (o.time += 60), o._emit("frame", r), o.frames++, o._request(t)) : o._emit("end").close()
      })
    },
    pause: function () {
      return this._cancel()
...
document.onreadystatechange = function () {
  var e = document.getElementById("page");
  "interactive" == document.readyState && window.setTimeout(function () {
    disableLoad()
  }, 4e3), "complete" == document.readyState && e.classList.contains("js-hidden") && disableLoad()
};
window.addEventListener("load", function () {
  ...
  (n = document.getElementById("page-header")) && document.addEventListener("scroll", function () {
    ...
    function () {
      ...
      if (e && n) {
        var t = new Pack(n);
        t.base("js-open").transfrom("page__nav--open"), e.addEventListener("click", function () {
          t.toggle()
        })
      }
    }(),
    function () {
      ...
      if (e) {
        var n = e.querySelector(".info__title"),
          t = e.querySelector(".info__desc");
        n && new Pack(n).animation("js-animation").end(function () {
          ["js-animation"].forEach(function (e) {
            n.classList.remove(e)
          })
        }).toggle(), t && new Pack(t).base("js-ease-out-leave-active").base("js-ease-out-leave").transfrom("js-ease-out-enter-active").end(function () {
...
window.addEventListener("load", function () {
  ! function () {
    ...
    if (o) {
      ...
      e.transfrom("back-top--hidden").base("js-hidden").lastStart(), t(), document.addEventListener("scroll", t), o.addEventListener("click", function () {
        (new Amt).from({
      ...
      if (!n.parentElement.parentElement.classList.contains("js-hidden")) {
        ...
        i.base("js-ease-out-leave-active").base("js-ease-out-leave").transfrom("js-ease-out-enter-active").end(function () {
          ...
          function (e) {
            ...
            function o() {
              i(n), n = t(e.bind(null, function () {
                document.removeEventListener("scroll", o)
              }))
            }
            document.addEventListener("scroll", o), o()
          }(function (e) {
